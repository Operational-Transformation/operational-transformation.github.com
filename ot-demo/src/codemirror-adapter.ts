...
function posLe (a: Position, b: Position) { return cmpPos(a, b) <= 0; }
...
export class CodeMirrorAdapter {
  ...
  static operationFromCodeMirrorChanges(changes: EditorChangeLinkedList[], doc: Doc): [TextOperation, TextOperation] {
    ...
    function updateIndexFromPos (indexFromPos: (pos: Position) => number, change: EditorChangeLinkedList): (pos: Position) => number {
